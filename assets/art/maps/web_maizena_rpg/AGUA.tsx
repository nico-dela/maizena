...
<tileset version="1.10" tiledversion="1.11.2" name="AGUA" tilewidth="16" tileheight="16" tilecount="14" columns="14">
 <image source="ASSETS/AGUA_Tobeco.png" width="224" height="16" />
 <tile id="0">
  <animation>
